// Rate limiting middleware for Image Service
...
export const imageGenerationRateLimiter = rateLimiter({
  windowMs: 60 * 1000, // 1 minute
  maxRequests: 3, // 3 image generations per minute (expensive operation)
})

export const styleRateLimiter = rateLimiter({
  windowMs: 60 * 1000, // 1 minute
  maxRequests: 30, // 30 style requests per minute
})

export const queueRateLimiter = rateLimiter({
  windowMs: 60 * 1000, // 1 minute
  maxRequests: 20, // 20 queue requests per minute
})
